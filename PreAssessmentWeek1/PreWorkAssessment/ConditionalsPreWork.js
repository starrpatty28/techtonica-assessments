...
function exercise4(varA, varB) {
  ...
  // --------------------------------------------
    if ( varA === varB) {
      console.log(varA + ' and ' + varB + ' are equal');
    } else {
...
exercise4('true', true);
   ...
   //you would think the bot would be true, but because they have 2 different data types they differ
